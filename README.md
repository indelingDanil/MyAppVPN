...
**Текущая версия: v2.0.0** — проект живой, фиксы и фичи выходят по мере нахождения проблем.

> ### 🧪 Доступна бета — v2.0.0-Beta
>
> Вышла пробная сборка с фиксами против главной болячки: раньше приложение само рвало **рабочее** соединение из-за слишком строгих внутренних проверок. Теперь оно доверяет балансировщику и не сбрасывает живой сервер на ровном месте.
>
> 👉 **[Скачать v2.0.0-Beta](../../releases/tag/v2.0.0-Beta)** — экспериментально, на ближайшие дни, для всех желающих потестить.
>
> Стабильной по-прежнему считается **v2.0.0** — если бета поведёт себя хуже, просто откатитесь на неё.
>
> **Кто хочет помочь:** отчёты по бете → в тему [#4 «Всемирная тестировка»](../../issues/4), идеи → [#5 «Всемирная идейная»](../../issues/5), просто пообщаться → [#6 «Всемирная флудильня»](../../issues/6). Любой фидбэк полезен. 🙌
