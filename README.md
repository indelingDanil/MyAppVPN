...
**Текущая версия: v2.0.1** — проект живой, фиксы и фичи выходят по мере нахождения проблем.
...
> ### 🆕 Что нового в v2.0.1
>
> - **Свои подписки.** Настройки → Подписки: добавляйте/удаляйте свои ссылки на списки VLESS и
>   включайте/выключайте любой источник (встроенные тоже).
> - **Защита** пользовательских ссылок (только `https://`, без локальных/приватных адресов) +
>   поддержка base64-подписок.
>
> 👉 **[Скачать v2.0.1](../../releases/latest)**
>
