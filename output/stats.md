...
Обновлено: **2026-09-12 16:44 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 964 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 206 |
