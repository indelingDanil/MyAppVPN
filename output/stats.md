...
Обновлено: **2026-07-29 17:11 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1742 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 288 |
