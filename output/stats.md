...
Обновлено: **2026-09-12 13:21 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 951 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 219 |
