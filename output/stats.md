...
Обновлено: **2026-07-27 22:58 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1896 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 473 |
