...
Обновлено: **2026-07-18 17:53 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1547 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 330 |
