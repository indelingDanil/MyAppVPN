...
Обновлено: **2026-08-09 22:27 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1873 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 488 |
