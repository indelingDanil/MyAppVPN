...
Обновлено: **2026-08-03 22:06 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1827 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 328 |
