...
Обновлено: **2026-09-08 06:55 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 2408 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 472 |
