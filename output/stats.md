...
Обновлено: **2026-08-05 23:55 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1671 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 381 |
