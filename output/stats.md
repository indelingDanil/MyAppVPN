...
Обновлено: **2026-08-22 17:21 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1241 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 371 |
