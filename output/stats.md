...
Обновлено: **2026-09-11 18:07 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 863 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 204 |
