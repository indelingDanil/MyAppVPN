...
Обновлено: **2026-08-24 17:31 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1238 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 319 |
