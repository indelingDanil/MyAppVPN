...
Обновлено: **2026-08-19 16:27 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1405 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 430 |
