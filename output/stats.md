...
Обновлено: **2026-07-30 10:20 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1960 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 264 |
