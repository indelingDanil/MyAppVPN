...
Обновлено: **2026-08-25 22:26 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1511 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 453 |
