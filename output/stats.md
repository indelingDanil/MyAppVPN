...
Обновлено: **2026-07-14 21:51 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1252 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 222 |
