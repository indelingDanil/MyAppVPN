...
Обновлено: **2026-09-04 12:03 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 2066 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 497 |
