...
Обновлено: **2026-08-13 11:46 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1370 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 365 |
