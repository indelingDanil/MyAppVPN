...
Обновлено: **2026-08-23 17:22 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1371 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 457 |
