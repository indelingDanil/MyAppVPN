...
Обновлено: **2026-07-19 16:51 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1822 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 290 |
