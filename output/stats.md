...
Обновлено: **2026-07-25 13:06 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1927 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 357 |
