...
Обновлено: **2026-08-16 15:19 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1497 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 425 |
