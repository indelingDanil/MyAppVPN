...
Обновлено: **2026-07-26 16:52 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1980 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 406 |
