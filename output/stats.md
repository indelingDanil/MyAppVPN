...
Обновлено: **2026-08-25 15:44 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1307 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 405 |
