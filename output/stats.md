...
Обновлено: **2026-08-28 19:55 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1022 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 296 |
