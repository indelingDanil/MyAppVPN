...
Обновлено: **2026-08-07 21:35 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1105 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 221 |
