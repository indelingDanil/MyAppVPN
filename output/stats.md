...
Обновлено: **2026-08-10 16:49 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1243 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 306 |
