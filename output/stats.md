...
Обновлено: **2026-08-12 15:58 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1333 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 348 |
