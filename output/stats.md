...
Обновлено: **2026-07-23 11:06 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1910 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 277 |
