...
Обновлено: **2026-08-21 19:27 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1162 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 341 |
