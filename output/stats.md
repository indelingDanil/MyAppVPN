...
Обновлено: **2026-09-10 12:11 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1135 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 311 |
