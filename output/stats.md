...
Обновлено: **2026-09-13 19:13 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 892 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 218 |
