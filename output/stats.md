...
Обновлено: **2026-08-13 23:38 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1264 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 423 |
