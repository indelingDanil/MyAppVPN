...
Обновлено: **2026-08-24 10:38 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1565 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 421 |
