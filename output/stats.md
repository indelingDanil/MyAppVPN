...
Обновлено: **2026-08-24 12:34 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1286 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 419 |
