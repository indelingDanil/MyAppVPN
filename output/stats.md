...
Обновлено: **2026-07-22 16:21 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1645 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 470 |
