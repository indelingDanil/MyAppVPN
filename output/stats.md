...
Обновлено: **2026-08-16 13:32 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1635 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 410 |
