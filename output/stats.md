...
Обновлено: **2026-07-20 05:38 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 2426 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 451 |
