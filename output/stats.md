...
Обновлено: **2026-08-12 17:58 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1269 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 379 |
