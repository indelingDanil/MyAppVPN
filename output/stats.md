...
Обновлено: **2026-08-23 13:35 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1388 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 448 |
