...
Обновлено: **2026-08-24 16:33 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1245 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 389 |
