...
Обновлено: **2026-09-03 21:41 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1734 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 456 |
