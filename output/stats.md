...
Обновлено: **2026-08-07 09:58 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1582 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 241 |
