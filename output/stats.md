...
Обновлено: **2026-08-20 09:33 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1970 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 433 |
