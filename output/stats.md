...
Обновлено: **2026-08-15 19:23 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1122 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 314 |
