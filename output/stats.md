...
Обновлено: **2026-09-16 23:30 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1037 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 253 |
