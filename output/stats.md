...
Обновлено: **2026-08-21 18:30 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1182 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 392 |
