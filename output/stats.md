...
Обновлено: **2026-08-18 19:29 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1071 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 335 |
