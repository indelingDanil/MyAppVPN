...
Обновлено: **2026-08-20 22:25 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1425 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 483 |
