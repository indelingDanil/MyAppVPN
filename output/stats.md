...
Обновлено: **2026-08-30 23:11 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1498 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 463 |
