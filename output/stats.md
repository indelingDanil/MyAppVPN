...
Обновлено: **2026-08-11 18:53 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1073 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 322 |
