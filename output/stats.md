...
Обновлено: **2026-08-03 17:49 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 1777 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 370 |
