...
Обновлено: **2026-08-07 04:55 UTC** · режим: **full / matrix** (каждый источник — свой параллельный job)

| Этап | Кол-во |
|------|-------:|
| Прошли Cloudflare + скорость (все источники) | 2825 |
| В подписке (Reality/TLS, ≥ 8 Мбит/с, top-500) | 479 |
